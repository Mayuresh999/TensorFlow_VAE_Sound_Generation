...
class VAE:
    ...
    def compile(self, leraning_rate = 0.0001):
        optimizer = tf.keras.optimizers.Adam(learning_rate=leraning_rate)
        self.model.compile(optimizer=optimizer, loss=self._calculate_combined_loss, metrics=[_calculate_reconstruction_loss, calculate_kl_loss(self)])
    ...
    def _calculate_combined_loss(self, y_target, y_predicted):
        recontruction_loss = _calculate_reconstruction_loss(y_target, y_predicted)
        kl_loss = calculate_kl_loss(self)()
        combined_loss = self.recontruction_loss_weight * recontruction_loss + kl_loss

        return combined_loss
    
    # def _calculate_recontruction_loss(self, y_target, y_predicted):
    #     error = y_target - y_predicted
    #     recontructed_loss = K.mean(K.square(error), axis=[1,2,3])

    #     return recontructed_loss
    ...
    def _add_decoder_input(self):
        return Input(shape=(None, self.latent_space_dim), name = 'decoder_input')
    ...
    def sampling_output_shape(input_shape):
        shape = input_shape[0]  # This is the shape of 'mu'
        return shape
...
if __name__ == "__main__":
    ...
    # In your _add_bottleneck function
    # def _add_bottleneck(self, x):
